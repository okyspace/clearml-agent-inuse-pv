...
ClearML Enterprise MLOps platform Task running agent
...
* <https://github.com/allegroai/clearml-enterprise-helm-charts>
...
|-----|------|---------|-------------|
| agentk8sglue | object | `{"additionalClusterRoleBindings":[],"additionalRoleBindings":[],"affinity":{},"annotations":{},"apiServerUrlReference":"https://api.clear.ml","applyVaultEnvVars":true,"basePodTemplate":{"affinity":{},"annotations":{},"containerSecurityContext":{},"env":[],"fileMounts":[],"hostAliases":[],"initContainers":[],"labels":{},"nodeSelector":{},"podSecurityContext":{},"priorityClassName":"","resources":{},"schedulerName":"","tolerations":[],"volumeMounts":[],"volumes":[]},"clearmlcheckCertificate":true,"containerCustomBashScript":"","containerSecurityContext":{},"createQueues":false,"customBashScript":"","debugMode":false,"defaultContainerImage":"ubuntu:18.04","extraEnvs":[],"fileMounts":[],"fileServerUrlReference":"https://files.clear.ml","image":{"registry":"","repository":"allegroai/clearml-enterprise-agent-k8s-base","tag":"1.24-58"},"labels":{},"maxPods":10,"monitoredResources":{"maxResources":0,"maxResourcesFieldName":"resources|limits|nvidia.com/gpu","minResourcesFieldName":"resources|limits|nvidia.com/gpu"},"nodeSelector":{},"podSecurityContext":{},"queues":null,"replicaCount":1,"serviceAccountClusterAccess":false,"serviceExistingAccountName":"","taskAsJob":false,"tolerations":[],"useOwnerToken":true,"volumeMounts":[],"volumes":[],"webServerUrlReference":"https://app.clear.ml"}` | This agent will spawn queued experiments in new pods, a good use case is to combine this with GPU autoscaling nodes. https://github.com/allegroai/clearml-agent/tree/master/docker/k8s-glue |
...
| agentk8sglue.applyVaultEnvVars | bool | `true` | push env vars from Clear.ML Vault to task pods |
...
| agentk8sglue.createQueues | bool | `false` | Create queues if they don't exist |
...
| agentk8sglue.image | object | `{"registry":"","repository":"allegroai/clearml-enterprise-agent-k8s-base","tag":"1.24-58"}` | Glue Agent image configuration |
...
| agentk8sglue.monitoredResources | object | `{"maxResources":0,"maxResourcesFieldName":"resources|limits|nvidia.com/gpu","minResourcesFieldName":"resources|limits|nvidia.com/gpu"}` | GPU resource general counters |
| agentk8sglue.monitoredResources.maxResources | int | `0` | Maximum resources counter |
| agentk8sglue.monitoredResources.maxResourcesFieldName | string | `"resources|limits|nvidia.com/gpu"` | Field name used by Agent to count maximum resources |
| agentk8sglue.monitoredResources.minResourcesFieldName | string | `"resources|limits|nvidia.com/gpu"` | Field name used by Agent to count minimum resources |
...
| agentk8sglue.queues | string | `nil` | ClearML queues and related template OVERRIDES used this agent will consume |
| agentk8sglue.replicaCount | int | `1` | Glue Agent number of pods |
| agentk8sglue.serviceAccountClusterAccess | bool | `false` | service account access every namespace flag |
...
| imageCredentials | object | `{"email":"someone@host.com","enabled":true,"existingSecret":"","password":"pwd","registry":"docker.io","username":"someone"}` | Private image registry configuration |
| imageCredentials.email | string | `"someone@host.com"` | Email |
| imageCredentials.enabled | bool | `true` | Use private authentication mode |
